...
* library = "http://smart.who.int/example-workshop/Library/IMMZD2DTMeaslesSupplementaryLogic"
* extension[+]
  * url = "http://hl7.org/fhir/StructureDefinition/cqf-knowledgeCapability"
  * valueCode = #computable
* url = "http://smart.who.int/example-workshop/PlanDefinition/IMMZD2DTMeaslesSupplementary"
