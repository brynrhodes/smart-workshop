...
* library = "http://smart.who.int/example-workshop/Library/IMMZD2DTMeaslesLTLogic"
* extension[+]
  * url = "http://hl7.org/fhir/StructureDefinition/cqf-knowledgeCapability"
  * valueCode = #computable
* url = "http://smart.who.int/example-workshop/PlanDefinition/IMMZD2DTMeaslesLT"
...
* action[+]
  ...
  * action[+]
    ...
    * action[+]
      * title = "Client Age Less Than 12 Months"
      * description = "Should not vaccinate client as client's age is less than 12 months. Check for any vaccines due, and inform the caregiver of when to come back for MCV1."
      * condition[+]
        * kind = #applicability
        * expression
          * language = #text/cql-identifier
          * expression = "Client Age Less Than 12 Months"
    * action[+]
